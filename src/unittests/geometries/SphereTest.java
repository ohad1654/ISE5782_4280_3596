...
class SphereTest {
    ...
    public void testGetNormal() {
        ...
        assertEquals(sphere.getNormal(new Point(1,0,0)),new Vector(1,0,0),
                "ERROR: Sphere Normal vector worng value");
    }
    ...
    public void testFindIntersections() {
        ...
        result=sphere.findIntersections(new Ray(new Point(0.5,0.5,0.5),new Vector(1,0,0)));
        assertEquals(1, result.size(), "Wrong number of points");
        p1=new Point(1.707106781187, 0.5, 0.5);
        assertEquals(List.of(p1),result,"Ray crosses sphere");

        // TC04: Ray starts after the sphere (0 points)
        assertNull(sphere.findIntersections(new Ray(new Point(2,0.5,0.5),new Vector(1,0,0))),
                "Ray's line out of sphere");
        ...
        assertNull(sphere.findIntersections(new Ray(new Point(2,0,0),new Vector(0,0,1))),
                "Ray's line out of sphere");
        ...
        assertNull(sphere.findIntersections(new Ray(new Point(2.5,0,0),new Vector(0,0,1))),
                "Ray's line out of sphere");
    }
