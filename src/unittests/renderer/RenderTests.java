...
public class RenderTests {
	...
	public Geometries baseRectangleTwo(Point p1, Point p7, Color mainColor)
	{
		Geometries geo = new Geometries();
		double X = p7.subtract(p1).getX();
		double Y = p7.subtract(p1).getY();
		double Z = p7.subtract(p1).getZ();
		geo.add(
				new Polygon(p1,p1.add(new Vector(0,0,Z)),p1.add(new Vector(X,0,Z)),p1.add(new Vector(X,0,0))).setEmission(mainColor).setMaterial(new Material().setKd(new Double3(0.2)).setKs(new Double3(0.2)).setShininess(100))
				,new Polygon(p1,p1.add(new Vector(X,0,0)),p1.add(new Vector(X,Y,0)),p1.add(new Vector(0,Y,0))).setEmission(mainColor).setMaterial(new Material().setKd(new Double3(0.2)).setKs(new Double3(0.2)).setShininess(100))
				,new Polygon(p1.add(new Vector(0,0,Z)),p1.add(new Vector(X,0,Z)),p7,p1.add(new Vector(0,Y,Z))).setEmission(mainColor).setMaterial(new Material().setKd(new Double3(0.2)).setKs(new Double3(0.2)).setShininess(100))
				,new Polygon(p1.add(new Vector(0,Y,0)),p1.add(new Vector(0,Y,Z)),p7,p1.add(new Vector(X,Y,0))).setEmission(mainColor).setMaterial(new Material().setKd(new Double3(0.2)).setKs(new Double3(0.2)).setShininess(100))
				,new Polygon(p1,p1.add(new Vector(0,Y,0)),p1.add(new Vector(0,Y,Z)),p1.add(new Vector(0,0,Z))).setEmission(mainColor).setMaterial(new Material().setKd(new Double3(0.2)).setKs(new Double3(0.2)).setShininess(100))
				,new Polygon(p1.add(new Vector(X,0,0)),p1.add(new Vector(X,Y,0)),p7,p1.add(new Vector(X,0,Z))).setEmission(mainColor).setMaterial(new Material().setKd(new Double3(0.2)).setKs(new Double3(0.2)).setShininess(100))
		);
	...
	public Geometries basePool(Point point,double size)
	{
		Point centerPool = point;
		Color colorPool = new Color(0,102,255);
		Geometries geo = new Geometries();
		geo.add(
				new Circle((centerPool.add(new Vector(0,0,0.00001))),size + 1,new Plane(new Point(0, 0, 0.000001),new Vector(0, 0, 1))).setEmission(new Color(9,34,6)).setMaterial(new Material().setKd(new Double3(0.2)).setShininess(100))
				,new Circle((centerPool.add(new Vector(0,0,0.0001))),size,new Plane(new Point(0, 0, 0.00001),new Vector(0, 0, 1))).setEmission(colorPool.add(new Color(15,15,0))).setMaterial(new Material().setKd(new Double3(0.07)).setKs(new Double3(0.8)).setShininess(100).setKr(new Double3(0.2)))
				,new Circle((centerPool.add(new Vector(0,0,0.0002))),size - 1,new Plane(new Point(0, 0, 0.00002),new Vector(0, 0, 1))).setEmission(colorPool.add(new Color(10,10,0))).setMaterial(new Material().setKd(new Double3(0.04)).setKs(new Double3(0.85)).setShininess(100).setKr(new Double3(0.25)))
				,new Circle((centerPool.add(new Vector(0,0,0.0003))),size - 2,new Plane(new Point(0, 0, 0.00003),new Vector(0, 0, 1))).setEmission(colorPool.add(new Color(05,05,0))).setMaterial(new Material().setKd(new Double3(0.06)).setKs(new Double3(0.85)).setShininess(100).setKr(new Double3(0.3)))
				,new Circle((centerPool.add(new Vector(0,0,0.0004))),size - 3,new Plane(new Point(0, 0, 0.00004),new Vector(0, 0, 1))).setEmission(colorPool.add(new Color(0,0,0))).setMaterial(new Material().setKd(new Double3(0.03)).setKs(new Double3(0.85)).setShininess(100).setKr(new Double3(0.3)))
	...
	public Geometries baseTree(Point centerWood,double sizeWood){
			Color brick = new Color(130,70,0).scale(0.5);
			Color leaf = new Color(110,213,66).scale(0.5);
	...
	public void HomeTest() {
		...
		scene.geometries.add( //
				...
				,basePool(new Point(-8,-5,0),3)
				,baseTree(new Point(-10,1,0),2)

			//	,createHome(new Point(25,0,0))
				,basePool(new Point(30,20,0),2)
				,baseBench(new Point(30,25,0))
			//	,baseBench(new Point(12,-2,0))
				,baseTree(new Point(40,25,0),1.5)
		);
		scene.lights.add(new DirectionalLight(new Color(255, 255, 128), new Vector(-10,20,-15)));
		System.out.println(new Point(10,-20,15).distance(new Point(10,0,5)));
		Camera camera = new Camera(new Point(10,-20,15),new Point(10,0,5)
		)
				.setGridSize(9)
				.setApt(0.3)
				.setFocalLength(22)
	...
	private Geometries createHome(Point position) {
		...
		return new Geometries(
				...
				,new Polygon(position.add(new Vector(0,10,0)),position.add(new Vector(10,10,0)),position.add(new Vector(10,10,10)),position.add( new Vector(0,10,10))).setEmission(new Color(BLUE).scale(0.5)).setMaterial(new Material().setKd(new Double3(0.2)))
				//pol1a
